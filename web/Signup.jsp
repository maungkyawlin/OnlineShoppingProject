        ...
        <div class="row g-0 border-0 bg-dark text-white">
            <div class="col-sm-6">
                <div class="card border-0 bg-dark ">
                    <div class="card-body ">
                        <form action="sigupAction.jsp"  method="POST" class="img-fluid rounded-start" id="myform">
                            <div class=" m-2">
                            ...
                            <div class=" m-2">
                              ...
                              <input type="number"class="form-control" width="200px" name="mobile" placeholder="Enter Your Mobile Number" required />
                             </div>
                            <div class=" m-2">
                           ...
                           <div class=" m-2">
                            ...
                            <div  class="m-2" >
                                 <button type="submit" class="btn btn-outline-info">Signup <i class="far fa-arrow-alt-circle-right"></i></button>
                                 <button type="reset" class="btn btn-outline-secondary">Reset <i class="far fa-window-close"></i></button>
                ...
                <div class="col-sm-6 mt-5">
                    ...
                    if("vaild".equals(msg)){
                    %>
                    <h1 class="text-success">Register Successfully!</h1>
