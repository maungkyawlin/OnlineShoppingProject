            ...
            <div class="row">
                <div class="col-md-12">
                    <table id="tbl-student " class="table table-responsive table-bordered mt-3 text-center"  cellpadding="0" width="100%">
                        ...
                        <center><h1>User Order <i class="fas fa-archive"></i></h1><hr></center>
                        </thead>
                       <thead class="bg-dark text-white">
                        <th>Order.NO</th>
                        <th>Email</th>
                        ...
                        <th>Expected Date</th>
                        <th>Status</th>
                        <th>Delivery Order <i class="fas fa-dolly"></i></th>
                       ...
                       if("delivery".equals(msg)){%>
                        ...
                        %>
                             ...
                             <tr> 
                                    ...
                                    <td><a class="btn btn-outline-dark"   href="deliveryOrder.jsp?id=<%=rs.getString(2)%> &email=<%=rs.getString("email")%>">Delivery <i class="fas fa-dolly"></i>  </a></td>
                                    
                                    <td><a class="btn btn-outline-danger " href="deleteOrder.jsp?id=<%=rs.getString(2)%>&email=<%=rs.getString("email")%>"> Cancel <i class="fas fa-window-close"></i></a></td>
                                </tr>  
