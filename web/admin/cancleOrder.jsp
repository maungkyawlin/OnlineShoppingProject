            ...
            <div class="row">
                <div class="col-md-12">
                    <table id="tbl-student " class="table table-responsive table-bordered mt-3 text-center"  cellpadding="0" width="100%">
                        ...
                        <center><h1>Cancel Order <i class="fas fa-window-close"></i></h1><hr></center>
                        </thead>
                       <thead class="bg-dark text-white">
                        <th>Order.NO</th>
                        <th>Email</th>
                       ...
                       if("delivery".equals(msg)){%>
                        ...
                        try{  
                            ...
                            String sql="select * from cart inner join product where cart.product_id=product.id and cart.orderDate is not NULL and cart.status='Cancle'";
