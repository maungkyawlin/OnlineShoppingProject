                ...
                <div class="card border-0 bg-dark  text-white mt-3" style="border-radius: 20px;">
                    ...
                    %>
                        <form action="changeProfileAction.jsp"  method="POST" class="img-fluid rounded-start " id="myform" >
                            <div class=" m-2">
                                <h2 class="text-center"> Change Email & Name <i class="fas fa-user-circle"></i> <hr></h2>
                            </div>
                             <div class=" m-2">
                             ...
                             <div class=" m-2">
                                ...
                                <input type="email" class="form-control" name="newemail" placeholder="Change Your Email" required />
                            </div>
                            <div class=" m-2">
                            ...
                            <div class=" m-2">
                                ...
                                <select name="securityQuestion" required="" class="form-control" placeholder="">
                                    <option value="">Enter Your Security Question</option>
                           ...
                           <div class=" m-2">
                            ...
                            <div  class="m-2" >
                               <button type="submit" class="btn btn-outline-info">Change Email & Name <i class="far fa-arrow-alt-circle-right"></i></button>
