                ...
                <div class="card border-0 bg-dark  text-white mt-3" style="border-radius: 20px;">
                    ...
                    %>
                        <form action="changeProfileAction.jsp"  method="POST" class="img-fluid rounded-start " id="myform" >
                            <div class=" m-2">
                                <h2 class="text-center"> Change Security Question & Answer <i class="fas fa-user-circle"></i> <hr></h2>
                            </div>
                           ...
                           <div class=" m-2">
                            ...
                            <div class="m-2 form-group pass_show">
                                ...
                                <input type="password" name="newpassword" class="form-control" value="Enter Your Password" required> 
                            </div>
                            <div  class="m-2" >
                               <button type="submit" class="btn btn-outline-info">Change Security Question & Answer <i class="far fa-arrow-alt-circle-right"></i></button>
