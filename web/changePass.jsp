                        ...
                        <form action="changeProfileAction.jsp"  method="POST" class="img-fluid rounded-start " id="myform" >
                            <div class=" m-2">
                             ...
                             <div class=" m-2">
                                ...
                                <input type="email" class="form-control" name="newname" placeholder="Enter Your Email" required />
                            </div>
                           ...
                           <div class=" m-2">
                            ...
                            <div class="m-2 form-group pass_show">
                                ...
                                <input type="password" name="connewpassword" class="form-control" value="Change Your Password" required> 
                            </div>
                            <div  class="m-2" >
                               <button type="submit" class="btn btn-outline-info">Change Password <i class="far fa-arrow-alt-circle-right"></i></button>
